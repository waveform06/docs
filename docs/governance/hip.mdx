...
Today, there are two HIP Editor's on the Helium Foundation team who are supported by
additional subject matter experts. Contact username waveformiot on discord as a first point of contact.
...
- At the same time, the HIP Editor begins a conversation with the HIP Author on Discord or Github to
  ...
  needed.
- HIP Editors define the subNetwork and Voting Requirements for the HIP.
...
- HIP Editors engage Authors to present HIPs at a following upcoming Community Call or Public event.
...
All HIPs that have been approved by a vote and been deployed in the Helium Community can be found at 
https://github.com/helium/HIP/blob/main/README.md
Not all HIPs proceed to vote or  pass super-majority voting, so you will see some that were closed 
or rejected on the list.  Just like bills that become law, HIPs often amend each other. 
