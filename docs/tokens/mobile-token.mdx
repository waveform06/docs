...
HIPs<sup>(</sup>[^1]<sup>,</sup>[^2]<sup>,</sup>[^3]<sup>,</sup>[^7]<sup>)</sup>.
...
The issuance is scheduled to have halvings every 2 years, aligning with HNT issuance halvings on Aug 1st.

The emission schedule was created in [HIP-53][hip-53-emissions], updated in
[HIP-75][hip-75-emissions], confirmed in [HIP-77][hip-77-emissions] later updated with [HIP-79][hip-79-summary] and is as follows:

| Year | MOBILE at Year Start | MOBILE Minted                     | Proof of Coverage <sup>(</sup>[^6]<sup>)</sup> | Hotspot Data <sup>(</sup>[^6]<sup>)</sup> | Mappers | Service Providers | Oracles <sup>(</sup>[^5]<sup>)</sup> | veHNT Stakers |
| ---- | -------------------- | --------------------------------- | ---------------------------------------------- | ----------------------------------------- | ------- | ----------------- | ------------------------------------ | ------------- |
| 1    | 50B                  | 110B <sup>(</sup>[^4]<sup>)</sup> | 20%                                            | 40%                                       | 20%     | 10%               | 4%                                   | 6%            |
...
[^7]: [HIP-79: Mobile PoC - Mappers Rewards][hip-79]
...
[[hip-79-summary]:
  https://github.com/helium/HIP/blob/main/0079-mobile-poc-mappers-rewards.md#summary
